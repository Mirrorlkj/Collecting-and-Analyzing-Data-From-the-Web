...
Though the predictor has a low *p*-value, the coefficiency is only 0.01. Based on the model, population density may not be a good estimator for average life expectancy. 