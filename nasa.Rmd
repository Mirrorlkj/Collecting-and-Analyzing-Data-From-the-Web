...
As stated on the NASA websites:all asteroids with a minimum orbit intersection distance (MOID) of 0.05 au or less and an absolute magnitude (H) of 22.0 or less are considered PHAs.[^2] Here, I did a simple confimation of the statement on the relationship bewteen the absolute magnitude and PHAs from the actual dataset. 
...
# Relationship
To confirm the stated reltionship between the magnitude and hazardousness, here, I put them into the same plot.
```{r}
asteroid %>%
...
From the graph, it is true that all the hazardousness asteroids are below the absolute magnitude (H) of 22.0. But not all asteroids that are not considered hazarous are over the absolute magnitude (H) of 22.0, this is because some of the asteroids below the absolute magnitude (H) of 22.0 may not have a minimum orbit intersection distance (MOID) of 0.5 or less.

# Conclusion 
Overall, we prove that the smaller absolute magnitude of an asteorid is, the more likely it is a potentially hazardous asteroid. This relationship can be identified in the graph below:
```{r}
asteroid %>%
